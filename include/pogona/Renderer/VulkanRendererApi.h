...
typedef enum {
	...
	VULKAN_RENDERER_COULD_NOT_PICK_PHYSICAL_DEVICE,
	VULKAN_RENDERER_NO_PHYSICAL_DEVICE_GROUPS,
	VULKAN_RENDERER_NO_QUEUE_FAMILY_PROPERTIES,
	VULKAN_RENDERER_NO_QUEUE_WITH_GRAPHICS_BIT,
	VULKAN_RENDERER_COULD_NOT_CREATE_DEVICE,
